...
<div class="text-center" style="padding:10px 0">
    <div class="main-login-form" style="padding:15px 0" >
        <div class="">
            <div class="form-group login-form-1 login-group">
                <h5 for="PersonasInvitadas" class="text-center text-dark">Influencia de la población sobre la cantidad de fallecidos</h5>
    ...
    <div class="main-login-form" style="padding:15px 0" >
        <div class="">
            <div class="form-group login-form-1 login-group">
                <h5 for="PersonasInvitadas" class="text-center text-dark">Influencia de los sintomas sobre la cantidad de fallecidos</h5>
    ...
    <div class="main-login-form" style="padding:15px 0" >
        <div class="">
            <div class="form-group login-form-1 login-group">
                <h5 for="PersonasInvitadas" class="text-center text-dark">Influencia de las muestras sobre la cantidad de fallecidos</h5>
    ...
    <div class="main-login-form" style="padding:15px 0" >
        <div class="">
            <div class="form-group login-form-1 login-group">
                <h5 for="PersonasInvitadas" class="text-center text-dark">Influencia de las personas vacunadas sobre la cantidad de fallecidos</h5>
